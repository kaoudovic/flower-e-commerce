	...
	<body>
		<div id="container">
			...
			<div id="content">
				...
				<br clear=left>
				<?php
					$q=mysql_query("select * from products order by prod_id desc");	//latest 3 products
					if($q)
					{
						while($r=mysql_fetch_assoc($q))
						{
							...
							if($offer_price)
							{
								...
								echo "<span  class='price'>$price \$</span>";
							echo "<br><a class='order_now' href='addtocart.php?prod_id=$prod_id'>Order Now</a>";
							echo "<a  href='detail_product.php?id=$prod_id'>detail</a></div>";
